...
/// A basic wrapper around CRDTMap that associates site IDs to atom IDs, functioning as cursors.
public struct CursorMap: CvRDT
{
    public typealias CRDTMapT = ORDTMap<CausalTreeString.SiteUUIDT, AtomId, CausalTreeString.SiteUUIDT>
    ...
    public func transferToNewOwner(withUUID uuid: CursorMap.SiteUUIDT, clock: Clock) -> ([SiteId:SiteId])
    {
    ...
    public func integrate(_ v: inout CursorMap)
    {
    ...
    public func superset(_ v: inout CursorMap) -> Bool
    {
    ...
    public static func ==(lhs: CursorMap, rhs: CursorMap) -> Bool
    {
